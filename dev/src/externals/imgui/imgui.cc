...
void imguiDrawLine(int x0, int y0, int x1, int y1, int r, unsigned int color) {
  addGfxCmdLine((float)x0, (float)y0, (float)x1, (float)y1, (float)r, color);
}

void imguiDrawRect(int x, int y, int w, int h, unsigned int color) {
  addGfxCmdRect((float)x, (float)y, (float)w, (float)h, color);
}

void imguiDrawRoundedRect(int x, int y, int w, int h, int r, unsigned int color) {
  addGfxCmdRoundedRect((float)x, (float)y, (float)w, (float)h, (float)r, color);
}